  ...
  return (
    <div className="max-w-screen-xl py-10 mx-auto">
      <div className="grid gap-2 md:gap-5 grid-cols-3 md:grid-cols-5">
        <div className="p-1 md:p-5 flex items-center flex-col shadow-md rounded-md badge-ghost">
      ...
      <div className="grid py-5 gap-5 grid-cols-12">
        <div className="shadow-md rounded-md badge-ghost min-h-screen col-span-9">
            <Table></Table>
        </div>
